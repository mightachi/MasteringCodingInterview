-- Analyze Slot Usage by Labels (User-Specific Version)
-- This version uses JOBS_BY_USER which has lower permission requirements
-- Use this if you don't have access to JOBS_BY_PROJECT
-- Replace 'region-us' with your BigQuery region if different

-- NOTE: This query only shows jobs created by the current user
-- For project-wide analysis, use analyze_slot_usage_by_labels.sql
-- (requires roles/bigquery.admin or custom permissions)
